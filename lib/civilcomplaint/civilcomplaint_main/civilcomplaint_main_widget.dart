...
import 'civilcomplaint_main_model.dart';
export 'civilcomplaint_main_model.dart';

class CivilcomplaintMainWidget extends StatefulWidget {
  const CivilcomplaintMainWidget({super.key});

  static String routeName = 'CivilcomplaintMain';
  static String routePath = '/civilcomplaintMain';

  @override
  State<CivilcomplaintMainWidget> createState() =>
      _CivilcomplaintMainWidgetState();
}

class _CivilcomplaintMainWidgetState extends State<CivilcomplaintMainWidget> {
  late CivilcomplaintMainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CivilcomplaintMainModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Align(
                      alignment: AlignmentDirectional(-0.27, -0.62),
                      child: Container(
                        width: 344.2,
                        height: 111.7,
                        decoration: BoxDecoration(
